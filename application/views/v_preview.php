...
<body>
    ...
    <body>
      <div class="container">
        <div class="main">
          <div class="content-white turun"><br<br<
              <h2><center>Selamat Data Anda Telah Masuk</center></h2>
              <p>Anda dapat melihat hasil anda sementara di halaman penerimaan, harap diperhatikan bahwa data tersebut merupakan data sementara, dan dapat berubah sewaktu-waktu.</p><br><br>
              <p>Terimakasih atas pendaftarannya, semoga diberikan hasil yang terbaik.</p><br>
            </div>
        </div>
      </div>
        <div class="footer">
