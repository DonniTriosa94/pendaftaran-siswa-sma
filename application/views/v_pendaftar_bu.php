...
<body>
		...
		<div class="header">
			<div class="container">
				<div class="logo">
					<a href="index.html"><img src="../../plugin/images/logo.png" alt=""></a>
				</div>
					<div class="menu">
					...
					<ul class="nav" id="nav">
						...
						<li><a href="v_penerima.php">Penerimaan</a></li>
		...
		<div class="content-white turun">
			<?php echo form_open_multipart('c_tubes/upload')?>
					 ...
					 <div class="form-group row">
						...
						<?php echo form_submit('upload','SIMPAN'); ?>
						<?php echo anchor('c_tubes/index','Kembali');?>
					<?php echo form_close();?>
					</div>
				</div>
				</div>
